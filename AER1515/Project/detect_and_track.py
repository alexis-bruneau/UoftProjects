    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image            
            ...
            if len(det):
                ...
                #cv2.line(frame, ((width/2),0), ((width/2),height), (255,0,0), 1) # Draw vertical red line on frames (image, start_point, end_point, color, thickness)


                # #Added lines to display x and y coordinates
                # for *xyxz, conf, cls in reversed(det):
